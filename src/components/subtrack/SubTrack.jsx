...
/* Welcome screen background. To show a photo or a short looping video of teachers using the app:
   1. Put the file in the repo's public/ folder (for example public/welcome.jpg).
   2. Set its path below (for example image: "/welcome.jpg").
   Use media you have permission to use. Photo: landscape, at least 1920px wide. Video: muted mp4/webm under 5MB.
   Leave all three empty to keep the gradient placeholder. */
const WELCOME_MEDIA = { image: "", video: "", poster: "" };
